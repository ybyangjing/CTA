...
class Net(nn.Module):
    def __init__(self,
                 ...
                 n_tasks,
                 args,
                 mas_coef=0.3, l2_coef=0.005):  # mas_coef=0.005 mas_coef=0.3
    ...
    def update_parameters(self, x, t, y):
        ...
        total_loss = current_task_loss + self.mas_coef * regularization_loss + loss_update + dist_loss   #0.3
        total_loss.backward()
        if self.mas_coef > 0:
    ...
    def compute_importance(self):
        ...
        # else:
        #     importances = [0] * len(importances)
        importances = [importance / max_importance for importance in importances]
        #print('importances:', importances)
        return importances
    def loss_with_importance(self, outputs, targets, importances, alpha=0.1): #alpha=0.1
